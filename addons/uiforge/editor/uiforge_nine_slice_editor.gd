@tool
class_name UIForgeNineSliceEditor
extends VBoxContainer

const PREVIEW_SCRIPT := preload("res://addons/uiforge/editor/uiforge_nine_slice_preview.gd")

signal style_save_requested(style_name: String, payload: Dictionary)

var preview: UIForgeNineSlicePreview
