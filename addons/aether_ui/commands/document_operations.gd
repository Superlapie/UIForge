class_name AetherDocumentOperations
extends RefCounted
...
static func get_node(document: AetherDocument, node_id: String) -> Dictionary:
...
static func inspect_tree(document: AetherDocument) -> Dictionary:
	return {"success": true, "tree": _tree_node(document.root())}

static func set_value(document: AetherDocument, node_id: String, property_path: String, raw_value: String) -> Dictionary:
...
static func add_value(document: AetherDocument, parent_id: String, raw_node: String) -> Dictionary:
...
static func delete_value(document: AetherDocument, node_id: String) -> Dictionary:
...
static func move_value(document: AetherDocument, node_id: String, parent_id: String, index: int = -1) -> Dictionary:
...
static func duplicate_value(document: AetherDocument, node_id: String, new_id: String) -> Dictionary:
